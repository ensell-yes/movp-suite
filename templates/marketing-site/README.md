...
A standalone MOVP marketing site and blog with CMS, SEO, and publish scheduling.

| Layer | Collections |
| --- | --- |
| Platform | `content_item`, `content_type`, `content_revision`, `content_seo`, `content_schedule`, `content_publish_event`, `tag`, `asset` |
| Project | `author`, `newsletter_subscriber` |
...
The local Supabase API is isolated on port `64621`. Set `SUPABASE_ANON_KEY` in
