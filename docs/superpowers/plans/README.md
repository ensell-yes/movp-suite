...
> | C6 Templates & Scaffolding | `2026-07-12-movp-stage-c-06{a,b,c,d,e,f}-*.md` (+ design/interfaces) | 🟨 C6a EXECUTED (platform artifact + schema composition + consumer reset gate); C6b–C6f pending |
