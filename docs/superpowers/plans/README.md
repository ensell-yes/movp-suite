...
> | C6 Templates & Scaffolding | `2026-07-12-movp-stage-c-06{a,b,c,d,e,f}-*.md` (+ design/interfaces) | 🟨 C6a–C6b EXECUTED (platform artifact/composition + injected schema/domain/runtime guard); C6c–C6f pending |
