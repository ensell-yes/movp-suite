...
> | Domain Workflows (`app-06`) | 06a–06c | 🟡 PARTIAL EXECUTED (06a catalog/event spine merged PR #3 `c96282a`; 06b automation engine merged PR #4 `0316279`; 06c webhook management on `codex/workflows-06c`; 06d pending) |
