...
> | C7 Inline Editing & Delivery | breakdown + `2026-07-15-c7.1-editor-dependency-spike.md` + `2026-07-16-movp-stage-c-07b-editor-sdk.md` + `2026-07-16-movp-stage-c-07c-content-binding-a.md` + `2026-07-16-movp-stage-c-07d-content-binding-b.md` | 🟡 C7.1–C7.3 EXECUTED; C7.3a (richtext canonicalization in `@movp/richtext` + hash-first idempotent `update_content`) and C7.3b (editor-SDK dirty/non-destructive conflict recovery, sanitized GraphQL `CONFLICT` boundary, bounded/observable richtext endpoint, shared-revision `RichTextFieldsIsland`, CMS page binding) COMPLETE — PR #26 CI green on `453f5b3`, incl. `slice-e2e: PASS` (clears the earlier `gte-small` download stop), publishable-versions, docs-freshness, workspace typecheck, `c7-editor-sdk`, and all four template-smoke (SDK 32, GraphQL 61, frontend unit/component 41, frontend e2e 86); reviewed 9.26; C7.4–C7.7 pending |
