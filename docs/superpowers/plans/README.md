...
> | C6 Templates & Scaffolding | `2026-07-12-movp-stage-c-06{a,b,c,d,e,f}-*.md` (+ design/interfaces) | 🟨 C6a–C6e EXECUTED (platform/composition + schema injection/runtime guard + immutable project codegen/manifest/live consistency + safe `create-movp` scaffolder + CRM-lite/marketing/support/knowledge-base gallery + four-way Verdaccio real-runtime matrix); C6f pending |
