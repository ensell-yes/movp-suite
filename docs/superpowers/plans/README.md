...
> | C3 Agent Connectivity (PATs/MCP/CLI) | `2026-07-09-movp-stage-c-03{a,b,c,d}-*.md` (+ design spec) | 🟡 IN PROGRESS — C3a PAT + C3b CLI + C3c MCP matrix/docs executed; C3d slice pending |
