...
> | C5 Integration Fabric | `2026-07-11-movp-stage-c-05{a,b,c}-*.md` (+ design spec) | ✅ EXECUTED (C5a delta-owned external records + idempotent ingest; C5b PostgREST RLS audit/docs; C5c CRM worker/templates/integration slice; 715 pgTAP assertions, direct HTTP/edge integration checks) |
