...
> | C7 Inline Editing & Delivery | breakdown + `2026-07-15-c7.1-editor-dependency-spike.md` + `2026-07-16-movp-stage-c-07b-editor-sdk.md` + `2026-07-16-movp-stage-c-07c-content-binding-a.md` | 🟡 C7.1–C7.2 EXECUTED; C7.3a IMPLEMENTED (focused unit/integration, typecheck, package/version/CI, five-entrypoint Deno, and 726-test pgTAP gates green; the combined slice passed those sections, then stopped later on the external `gte-small` model download); C7.3b and C7.4–C7.7 pending |
