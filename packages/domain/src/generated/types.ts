...
export interface AutomationRuleRow {
  ...
  action_type: 'notify' | 'deliver_webhook' | 'create_task' | 'advance_deliverable' | 'recompute_segment' | 'emit_event'
...
export interface WorkflowRunRow {
  ...
  matched: boolean
  action_type: string
  outcome: 'succeeded' | 'failed' | 'skipped' | 'enqueued'
  job_id: string | null
